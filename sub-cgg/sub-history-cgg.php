...
<section class="sub-content sub-history sub-history-cgg sub-content-center sub-section sub-section2 sub-section-scr sub-section2-scr" data-n="2">
...
<div class="sub-title-wrap sub-title-wrap-center">
  ...
  <script>
    cggArr.forEach(function(v) {
      $(`.sub-history .overflow .img_container`).append(`
          <li>
            <figure class="top-img">
              <img src="./img/sub/sub-history/cgg/${v.slideImg}" alt>
            </figure>
      ...
      v.imgArr.forEach(function(i) {
        $(`.img_container >li:last-child .bottom-content figure`).append(`
            <img src="./img/sub/sub-history/cgg/${i}" alt="">
          `)
      }) //imgArr
    }) //historyArr1
  </script>
