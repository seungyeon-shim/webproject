...
<video class="moon" src="./video/moon.mp4" loop muted autoplay playisline></video>
  ...
  <div class="sub-visual-slider">
    ...
    <script>
      for (var i = 1; i <= 3; i++) { 
        for (var j = 1; j <= 10; j++) {
          $(`.castle${i}`).append(`<img class="img${j} lg" src="./img/sub/sub-visual/cgg/cgg-${i}.png">`)
          $(`.castle${i}`).append(`<img class="img${j} sm" src="./img/sub/sub-visual/cgg/cgg-${i}s.png">`)
        }
      }
    </script>
  </div>
  <video class="season winter" src="./video/fall.mp4" loop muted autoplay playsInline></video>
</section>